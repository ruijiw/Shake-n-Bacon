 ...
 * descending order. This file is used for experiment test.
 * The argument is in the form of :
 * [-b, -a, -m, -h] [-is, -os, -hs] [file] [-k](for mergeSort to print k elements)
 */
        ...
        if(args[1].compareTo("-k") == 0){
	        ...
	        if (args[1].compareTo("-is") == 0) {
	        	...
	        	if(args[3].compareTo("k") == 0){
	        		...
	        		printDataCountTopK(counts, k);//merge sort to print k elements.
	        		return;
	        	}
	        } 
